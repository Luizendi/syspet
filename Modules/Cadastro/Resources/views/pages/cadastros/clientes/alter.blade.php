@extends('cadastro::layouts.app', ['activePage' => 'clientes', 'titlePage' => ''])
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="Codigo" class="form-control" id="codigo" value="{{ $clientes->cd_cliente }}" readonly required />
                                    </div>
                                </div>
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <label for="" class="bmd-label-floating">Nome</label>
                                        <input type="text" name="Nome" class="form-control" id="nome" value="{{ $clientes->nome }}" required />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="" class="bmd-label-floating">CNPJ/CPF</label>
                                        <input type="text" name="CnpjCpf" class="form-control" id="cnpjcpf" value="{{ $clientes->cnpjcpf }}" required />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="" class="bmd-label-floating">IE/RG</label>
                                        <input type="text" name="IeRg" class="form-control" id="ierg" value="{{ $clientes->ierg }}" required />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="" class="bmd-label-floating">Endereço</label>
                                        <input type="text" name="Endereco" class="form-control" id="endereco" value="{{ $clientes->endereco }}" required />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="" class="bmd-label-floating">CEP</label>
                                        <input type="text" name="CEP" class="form-control" id="cep" value="{{ $clientes->cep }}" required />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="" class="bmd-label-floating">Cidade</label>
                                        <input type="text" name="Cidade" class="form-control" id="cidade" value="{{ $clientes->cidade }}" required />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="" class="bmd-label-floating">Estado</label>
                                        <input type="text" name="Estado" class="form-control" id="estado" value="{{ $clientes->estado }}" required />
                                    </div>
                                </div>
                            </div>
                        </div>
