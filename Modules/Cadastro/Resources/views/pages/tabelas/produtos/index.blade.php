@extends('cadastro::layouts.app', ['activePage' => 'produtos', 'titlePage' => 'Produtos'])
...
@section('content')
    <div class="content">
        <div class="card">
            ...
            <div class="card-body">
                <div class="toolbar">
                    <a href="{{ route('produtos.new') }}" class="btn btn-primary"><i class="material-icons">add</i>
                        Novo</a>
                </div>
