@extends('cadastro::layouts.app', ['activePage' => 'tipoalta', 'titlePage' => 'Tipos de Alta'])
    ...
    <div class="content">
        <div class="card">
            <div class="card-header card-header-icon card-header-primary">
                ...
                <h4 class="card-title ">Lista dos Tipos de Alta</h4>
            </div>
            <div class="card-body">
                <div class="toolbar">
                    <a href="{{ route('tiposaltas.new') }}" class="btn btn-primary"><i class="material-icons">add</i>
                        Novo</a>
                </div>
